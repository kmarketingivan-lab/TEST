...
export function generateBookingReminderHtml(data: BookingReminderData): string {
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:100%;">
        ...
        <tr>
          <td style="padding:32px 24px;">
            <h2 style="margin:0 0 8px;color:#111827;font-size:20px;">Il tuo appuntamento &egrave; domani</h2>
            <p style="margin:0 0 24px;color:#6b7280;font-size:14px;">Ciao ${booking.customer_name}, ti ricordiamo il tuo appuntamento di domani.</p>
            ...
            <h3 style="margin:0 0 8px;font-size:14px;color:#111827;">Dove trovarci</h3>
